...
open class PinkBunnyAndroidExtension @Inject constructor(private val project: Project) {
    ...
    companion object {
        ...
        fun setup(project: Project): PinkBunnyAndroidExtension =
            project.extensions.create("pinkBunnyAndroid")
    }
}
